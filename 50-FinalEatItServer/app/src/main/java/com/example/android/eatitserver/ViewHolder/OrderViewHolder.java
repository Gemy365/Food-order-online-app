...
public class OrderViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView txtOrderId, txtOrderStatus, txtOrderPhone, getTxtOrderDate, txtOrderAddress, txtOrderClock;
...
//        txtOrderId = (TextView) itemView.findViewById(R.id.order_id);
        ...
        txtOrderClock = (TextView) itemView.findViewById(R.id.order_clock);
