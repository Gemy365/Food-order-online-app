...
//        });
        ...
        final MaterialEditText edtClock = (MaterialEditText) orderAddressComment.findViewById(R.id.edt_clock);
...
//                        address = shipingAddress.getAddress().toString();
                ...
                if (!edtAddress.getText().toString().equals("العنوان: ") && !edtClock.getText().toString().equals("الساعة: ")) {
                    Toast.makeText(Cart.this, "عرفنا مكانك و هنكون عندك فى الوقت اللى حددته", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Cart.this, "مكانك و الوقت هيساعدنا كتيير نقدملك خدمه ممتازه", Toast.LENGTH_LONG).show();
        ...
        data.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Notification notification = new Notification("الدمياطي", "أوردر جديد");
