...
import com.example.android.eatit.Model.DataMessage;
...
public class Cart extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void showAlertDialog() {
        ...
        // Radio For Location.
        final RadioButton rdiShipToAddress = (RadioButton) orderAddressComment.findViewById(R.id.rdi_ship_to_address);

        // When Choose First Radio.
        rdiShipToAddress.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                // Ship To This Address.
                if (true) {
                    // We Need Make Our Location Like This. [https://maps.googleapis.com/maps/api/geocode/json?latlng=16.0680,108.2130&sensor=false].
                            ...
                            .enqueue(new Callback<String>() {
                                ...
                                public void onResponse(Call<String> call, Response<String> response) {
                                    ...
                                    try {
                                        ...
                                        Toast.makeText(Cart.this, "Find your address" , Toast.LENGTH_SHORT).show();
...
//                    Sender content = new Sender(serverToken.getToken(), notification);
                    ...
                    dataSend.put("title", "Gemy");
                    dataSend.put("message", "You have new order " + rndmOrderNum);
                    DataMessage dataMessage = new DataMessage(serverToken.getToken(), dataSend);

                    Log.d("TOKEN", serverToken.getToken());
