...
import com.example.android.eatitserver.Commons.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mService = Commons.getGeoCodeService();
    ...
    private void displayLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if(mLastLocation != null){
                ...
                mMap.addMarker(new MarkerOptions().position(yourLocation).title("Yuor Location"));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(yourLocation));
                mMap.animateCamera(CameraUpdateFactory.zoomTo(17.0f));
                
                // After Add Marker For Your Location, Add Marker For This order And Draw Route.
                drawRoute(yourLocation, Commons.currentRequest.getAddress());
            }
            else
                Log.d("DEBUG", "Could not find your location");
        }
    }
        ...
        mService.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    bitmap = Commons.scaleBitamp(bitmap, 50, 50);

                    MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("Order of " + Commons.currentRequest.getPhone())
