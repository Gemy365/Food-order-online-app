...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // true doesn't mean that the RecyclerView size is fixed, just means it won't change because of change in the adapter content.
        ...
        searchAdapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(foodOptions) {
            ...
            protected void onBindViewHolder(@NonNull FoodViewHolder viewHolder, int position, @NonNull Food model) {
                ...
                Picasso.with(getBaseContext()).load(model.getImage())
                        .resize(500, 333).centerCrop().into(viewHolder.imgFoodView);
            ...
            protected void onBindViewHolder(@NonNull final FoodViewHolder viewHolder, final int position, @NonNull final Food model) {
                ...
                viewHolder.quickCart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(FoodList.this, "جاهز لطلب الأوردر", Toast.LENGTH_SHORT).show();
                    }
                });

                // To Make Replace " "  With "_" In Key Of New Food Created By Server's User.
                final String Str = String.valueOf(adapter.getRef(position).getKey());
                // // Check If It Fave Food.
                if (DBForFav.isFavorites(Str.replace(" ", "_")))
                    // Set Img To Be Fav.
                ...
                viewHolder.imgFav.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!DBForFav.isFavorites(Str.replace(" ", "_"))) {
                            ...
                            DBForFav.addToFavorites(Str.replace(" ", "_"));
                            ...
                            DBForFav.removeFromFavorites(Str.replace(" ", "_"));
