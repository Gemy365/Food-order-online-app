...
public class  Home extends AppCompatActivity
    ...
    // For Alert Dialog.
    MaterialEditText edtNameForNewFood;
    ...
    private void showAlertDialog() {
        ...
        // Get Name By Id.
        edtNameForNewFood = (MaterialEditText) addMenuLayout.findViewById(R.id.edit_name_for_new_food);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imgFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    newCategory = new Category(edtNameForNewFood.getText().toString(), uri.toString());
                                }
                            });
                        }
                    })
...
*/
    ...
    private void showUpdateDialog(final String key, final Category item) {
        ...
        // Set Default Name [Item's Name Into Menu].
        edtNameForNewFood.setText(item.getName());
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // Store New Name.
                item.setName(edtNameForNewFood.getText().toString());
                // Set New Name Into Image And In FireBase DataBase.
