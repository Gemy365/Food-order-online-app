...
public class OrderStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerOrder = (RecyclerView) findViewById(R.id.listOrders);
...
//              viewHolder.txtOrderId.setText(adapter.getRef(position).getKey());
                ...
                viewHolder.txtOrderClock.setText(model.getClock());
                viewHolder.getTxtOrderDate.setText(Commons.getDate(Long.parseLong(adapter.getRef(position).getKey())));
...
//                });
    ...
    private void showUpdateDialog(final String key, final Request item) {
        ...
        spinner.setItems("استلمنا الأوردر", "في طريقنا ليك", "الأوردر وصل");
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            ...
                            Notification notification = new Notification("الدمياطي", "" + Commons.convertCodeToStatus(item.getStatus()));
