...
public class Home extends AppCompatActivity
    ...
    // Slider Of Images.
    HashMap<String, String> imgSlider;
        ...
        banners.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapShot : dataSnapshot.getChildren()) {
                    // Get All Value From Banner On Firebase & Put IT Into Banner Class.
                    Banner banner = postSnapShot.getValue(Banner.class);

                    // We Will Use Name And ID Like
                    // PIZZA@01 => Will Use PIZZA For Show Description & 01 For Food ID To Click.
                    //Put Take Key Value.
                    imgSlider.put(banner.getName() + "@" + banner.getId(), banner.getImage());
                }
                // Split Key Of imgSlider To Name & ID.
                for (String key : imgSlider.keySet()) {
                    String keySplit[] = key.split("@");
                    String nameOfFood = keySplit[0];            // For Name Of Img Banner.
                    String idOfFood = keySplit[1];            // For ID Of Img Banner.

                    // Create Slider.
                    final TextSliderView textSliderView = new TextSliderView(getBaseContext());
                    textSliderView
                            .description(nameOfFood)
                            .image(imgSlider.get(key))  // Take Key Of imgSlider To Get Value [banner.getImage()].
                            .setScaleType(BaseSliderView.ScaleType.Fit)
                            .setOnSliderClickListener(new BaseSliderView.OnSliderClickListener() {
                                @Override
                                public void onSliderClick(BaseSliderView slider) {
                                    // When Press On Image Into Slider.
                    ...
                    // Send FoodId As A Key To FoodDetail Class With Value idOfFood.
    ...
    // On Resume Method To Make Update TO Count Orders If There's New Order.
    @Override
        ...
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder viewHolder, int position, @NonNull Category model) {
                ...
                Picasso.with(getBaseContext()).load(model.getImage())
                        .resize(300, 500).centerCrop().into(viewHolder.imgMenuView);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            // Return Back To Type New Number Into Account Kit.
            AccountKit.logOut();

            // GoTo MainActivity To Type New Number Into Account Kit.
    ...
    // To Allow Users To Active Notifications Or Close It.
    private void showSettingDialog() {
        ...
        View settingLayout = inflater.inflate(R.layout.setting_layout, null);

        // Get CheckBox By ID.
        final CheckBox chkSubNew = (CheckBox) settingLayout.findViewById(R.id.chk_sub_new);

        // Remember Choice Of User.
        // Init Paper.
        Paper.init(this);

        // Make Paper Read To Take Key To Get Value.
        String isSubscribe = Paper.book().read("sub_new");

        // Check If Check Box Is False.
        if (isSubscribe == null || TextUtils.isEmpty(isSubscribe) || isSubscribe.equals("false"))
            // Make Check Box Not Checked.
            chkSubNew.setChecked(false);

        else
            // Make Check Box Checked.
            chkSubNew.setChecked(true);

        // Set This View.
        alertDialog.setView(settingLayout);
        // Add Icon To Alert Dialog.
        alertDialog.setIcon(R.drawable.ic_settings_black_24dp);

        // Make Buttons For Alert Dialog [OK].
        // When Press On OK.
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (chkSubNew.isChecked()) {
                    // To Send Notifications For All Users
                    // Send Message From FirebaseMessaging To All Users.
                    FirebaseMessaging.getInstance().subscribeToTopic("news");
                    // Write Value For Paper.
                    Paper.book().write("sub_new", "true");
                } else {
                    // Don't Send Message From FirebaseMessaging To All Users.
    ...
    private void showChangePwdDialog() {
        ...
        // Make View Use Layout.
        View updateName = inflater.inflate(R.layout.update_name_layout, null);

        final MaterialEditText edtName = (MaterialEditText) updateName.findViewById(R.id.edt_name);

        // Set This View.
        alertDialog.setView(updateName);
        // Add Icon To Alert Dialog.
        ...
        alertDialog.setPositiveButton("UPDATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // Get Field Of name Into Fire Base To Add Name That User Typed It.
    ...
    // Start Slider Of Images Automatic.
    @Override
