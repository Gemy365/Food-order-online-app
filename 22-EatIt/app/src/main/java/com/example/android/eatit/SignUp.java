...
public class SignUp extends AppCompatActivity {
    ...
    // MaterialEditText & BtnView To Get IDs.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Check If InterNet Available , [getBaseContext() Equal SignUp.this].
                ...
                // From User Into Firebase Database Make It's Value Listen To This Change.
                table_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.child(edtPhone.getText().toString()).exists()) {
                            ...
                            // Make New Child [Phone] For [User] DataBase And Set Children Of This New Phone Number.
