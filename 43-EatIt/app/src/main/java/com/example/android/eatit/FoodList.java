    ...
    private void startSearch(CharSequence text) {
        ...
        searchAdapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(foodOptions) {
            ...
            protected void onBindViewHolder(@NonNull FoodViewHolder viewHolder, int position, @NonNull Food model) {
                ...
                // Set Price Of Food.
                viewHolder.txtFoodMoney.setText(String.format("$ %s", model.getPrice().toString()));
    ...
    private void loadListFood(String categoryId) {
        ...
        adapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(foodOptions) {
            ...
            protected void onBindViewHolder(@NonNull final FoodViewHolder viewHolder, final int position, @NonNull final Food model) {
                ...
                if (DBForFav.isFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone()))
                    // Set Img To Be Fav.
                ...
                viewHolder.imgFav.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!DBForFav.isFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone())) {
                            ...
                            DBForFav.addToFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone());
                            ...
                            DBForFav.removeFromFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone());
